...
public class App {
    ...
    public static void main(String[] args)
        ...
        //reactionManager.loadFromPackage("com.github.splendor_mobile_game.websocket.handlers.reactions");

        List<Class<?>> classes = new ArrayList<>();
        classes.add(CreateServer.class);
        classes.add(CreateRoom.class);
        classes.add(JoinRoom.class);
        reactionManager.loadReactions(classes);
