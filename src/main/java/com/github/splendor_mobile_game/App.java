...
import com.github.splendor_mobile_game.websocket.handlers.reactions.*;
...
public class App {
	...
	private static List<Class<?>> classesWithReactions = new ArrayList<>(Arrays.asList(
		CreateRoom.class, JoinRoom.class, DebugGetRandomCard.class, LeaveRoom.class, GetTokens.class, EndTurnTest.class, StartGame.class, BuyRevealedMine.class, MakeReservationFromDeck.class, BuyReservedMine.class, EndTurn.class,MakeReservationFromTable.class
	));
